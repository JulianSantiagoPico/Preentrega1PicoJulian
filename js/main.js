...
const guardarDatos = () => {
    ...
    let notaGuardada = document.getElementById("notaGuardada").value;
    const datosUsuario = {nombreUsuario:nombre, notaUsuario:notaGuardada};
...
const recuperarDatos = () => {
    ...
    let salida = `<p>Hola de nuevo: <b>${datosUsuario.nombreUsuario}</b><br> 
    Ultima nota que guardaste: <b>${datosUsuario.notaUsuario}<b></p>`;
    document.getElementById("resultadoCarga").innerHTML = salida;
